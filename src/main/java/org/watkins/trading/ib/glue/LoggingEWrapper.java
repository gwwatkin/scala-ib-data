...
package org.watkins.trading.ib.glue;
...
public class LoggingEWrapper implements EWrapper {
    protected EJavaSignal eJavaSignal = new EJavaSignal();
    protected EClientSocket eClientSocket = new EClientSocket(this, eJavaSignal);
